...
function initNavs2() {
  total.forEach(function(item, i) {
    ...
    moving_div.style.padding = '0px';
    moving_div.style.width = first_li.closest('li').offsetWidth + 'px';
    let translate3d=getTranslate3d(first_li,item);
    moving_div.style.transform = 'translate3d('+translate3d+'px, 0px, 0px)';
    moving_div.style.transition = '.5s ease';
...
function getTranslate3d(e,item){
  let li = e.closest('li'); // get reference
  let translate3d=0;
      if (li) {
        let nodes = Array.from(li.closest('ul').children); // get array
        let index = nodes.indexOf(li) + 1;
        ...
        console.log("index",index);
          let sum = 0;
            ...
            translate3d = sum;
            console.log("sumasssss",translate3d);
